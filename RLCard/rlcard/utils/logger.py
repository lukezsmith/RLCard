...
class Logger(object):
    ...
    def __init__(self, log_dir, file_prefix=""):
    ...
    def __enter__(self):
        self.txt_path = os.path.join(self.log_dir, self.file_prefix + '_log.txt')
        self.csv_path = os.path.join(self.log_dir, self.file_prefix + '_performance.csv')
        self.fig_path = os.path.join(self.log_dir, self.file_prefix + '_fig.png')
        ...
        fieldnames = ['timestep', 'reward', 'winrate']
    ...
    def log_winrate(self, timestep, reward, winrate):
        self.writer.writerow({'timestep': timestep, 'reward': reward, 'winrate': winrate})
        print('')
        self.log('----------------------------------------')
        self.log('  timestep     |  ' + str(timestep))
        self.log('  reward       |  ' + str(reward))
