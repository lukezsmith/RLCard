...
class NFSPARMAgent(object):
    ...
    def __init__(self,
        ...
        self._rl_agent = ARMAgent(q_replay_memory_size, q_replay_memory_init_size, \
            tau, q_discount_factor, q_batch_size,  \
            num_actions, state_shape, q_train_every, q_mlp_layers, \
