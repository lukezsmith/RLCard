...
def train(env, algorithm, opposition_agent, cuda, seed, num_episodes, num_eval_games, evaluate_every, log_dir):
    ...
    eval_env.set_agents([agents[0] ,opposition_agent_1])
    ...
    with Logger(log_dir) as logger:
      for episode in range(num_episodes):
          ...
          if episode % evaluate_every == 0:
              ...
              payoffs = tournament(eval_env, num_eval_games)
...
if __name__ == '__main__':
    ...
    train( env, algorithm, opposition_agent, cuda, seed, num_episodes, num_eval_games, evaluate_every, log_dir)
