...
from rlcard.utils import get_device, set_seed, tournament, reorganize, Logger, plot_winrate_curve, tournament_winnings
...
#     figure_path = './figures/'
    ...
    if opposition_agent == "rule-based":
        ...
        # eval_agent_1 = LeducHoldemRuleAgentV1()
        # eval_agent_2 = LeducHoldemRuleAgentV1()
        eval_agent_1 = models.load('leduc-holdem-cfr').agents[0]
        eval_agent_2 = models.load('leduc-holdem-cfr').agents[0]
