...
if __name__ == '__main__':
    ...
    env = rlcard.make('teamuno', config={'record_action': True})
    device = get_device()
    ...
    model_path = './uno_model_advanced.pth'
    agents = []
    ...
    random_agent1 = UNORuleAgentV1()
    random_agent2 = UNORuleAgentV1()
    ...
    while (True):
        ...
        for pair in _action_list:
            if pair[0] % 2 == 0:
                ...
                player_name = "Player " + str(pair[0]) + " (Rule-based Team)"
            print('>> ' ,player_name, 'chooses:')
        ...
        if len(set(payoffs)) == 1:
            ...
            if winner == 0 or winner == 2:
                ...
                winning_team = "Rule-based Agent Team"
            
            print(winning_team + " won the game!")

        in_rate = num_wins / num_games
